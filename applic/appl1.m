addpath /users/sista/imarkovs/mfiles/stls
addpath /users/sista/imarkovs/mfiles/stls/support
addpath /users/sista/imarkovs/mfiles/subid/subfun
addpath /users/sista/imarkovs/mfiles/ident
...
if (ff == 1)  
  ...
  thi_pem = idss(A,B,C,D,K); %myss2th(A,B,C,D,K);
  ...
  Ap = th_pem.A; Bp = th_pem.B; Cp = th_pem.C; Dp = th_pem.D; Kp = th_pem.K; %[Ap,Bp,Cp,Dp,Kp] = ssdata(ss(th_pem));
  [Ao,Bo,Co,Do] = ssdata(th_oe); %th2ss(th_oe);
  ...
  erko_id = NaN; %[du,erko_id] = predic(y,u,Ao,Bo,Co,Do,Kp,ax_id);
  [du,erkp_val] = predic(y,u,Ap,Bp,Cp,Dp,Kp,ax_val);
  erko_val = NaN; %[du,erko_val] = predic(y,u,Ao,Bo,Co,Do,Kp,ax_val);
