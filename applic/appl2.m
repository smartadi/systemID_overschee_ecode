...
%
  ...
  addpath /users/sista/imarkovs/mfiles/subspace/subfun
  addpath /users/sista/imarkovs/mfiles/jan
...
%th_oe  = pem([y_id,u_id],ini);
opt.exct = 1:m;
th_oe = stlsident([u_id,y_id],m,ceil(n/l),opt); 
tt2    = toc;

% Convert to state space
Ap = th_pem.A; Bp = th_pem.B; Cp = th_pem.C; Dp = th_pem.D; Kp = th_pem.K; %[Ap,Bp,Cp,Dp,Kp] = th2ss(th_pem);
%[Ao,Bo,Co,Do,Ko] = th2ss(th_oe);
[Ao,Bo,Co,Do] = ssdata(th_oe);
...
[du,erko_id]  = predic(y,u,Ap,Bp,Cp,Dp,Kp,ax_id);
[du,erkp_val] = predic(y,u,Ap,Bp,Cp,Dp,Kp,ax_val);
[du,erko_val] = predic(y,u,Ap,Bp,Cp,Dp,Kp,ax_val);
